...
int main(int argc, char *argv[]) {
	...
	Plot2dTypeDef plot1;		// Create a plotting structure
	plot2d_init(&plot1, N, 2);	// Assign a Gtk drawing area to plot1, determine samples, and number of plots
	...
	plot1.y[1] = y2;	// Assign y2[] to y axis
